...
while True:
	...
	envelope_adjust = (envelope - env_last_read)
	...
	if ( envelope_adjust > envtolerance ):
		envelope_increased = True

	if( envelope_adjust < -10):
		envelope_increased = False
...
if (audio_changed and gate_changed and envelope_increased):
	reading = 1;
